...
namespace ModernRealEstateBLL
{
    ...
    public abstract class Residential : Estate
    {
        ...
        public override string[] Details()
        {
            ...
            details[0] = "Residential Property : " + EstateType;
            ...
            if (Seller != null) details[5] = "Seller : " + Seller;
            else details[5] = "No Seller";

            if (Buyer != null) details[6] = "Buyer : " + Buyer;
            else details[6] = "No Buyer";
